#ifndef PITCHES_H // ifndef heißt: "if not defined" auf Deutsch: "Falls nicht defeniert."
#define PITCHES_H // Hier defenieren wir es.

// Hier defnieren wir die Noten.
//Die Nummer daneben sind in Hz, um die richtige Note zu spielen.
...
const int FUER_ELISE_MELODY[] PROGMEM = {
...
int _FETempo = 80;
int _FEnotes = sizeof(FUER_ELISE_MELODY) / sizeof(FUER_ELISE_MELODY[0]) / 2;
int _FEwholenote = (60000 * 4) / _FETempo;
int _FEdivider = 0;
int _FEnoteDuration = 0;
...
int _HPTempo = 144;
int _HPnotes = sizeof(HARRY_POTTER_MELODY) / sizeof(HARRY_POTTER_MELODY[0]) / 2;

// this calculates the duration of a whole note in ms (60s/tempo)*4 beats
int _HPwholenote = (60000 * 4) / _HPTempo;
int _HPdivider = 0;
int _HPnoteDuration = 0;
