...
namespace lcd {
    ...
    void in_colors_change_stage(color_stage &stage) {
        ...
        if (stage.option_clicked == true) {
            ...
            case color_stages::red:
                if (is_color_valid_and_apply(stage.display_color_value, stage) == false) {
                    speaker::current_state = speaker::states::playing_error_sound;
                    draw_normal_message(F("Not valid Color"), F("value"), 1, 5);
                }
                else {
            ...
            case color_stages::blue:
                if (is_color_valid_and_apply(stage.display_color_value, stage) == false) {
                    ...
                    speaker::current_state = speaker::states::playing_success_sound;
        ...
        if (remote_message_shown == false) {
            draw_normal_message(F("Use the remote"), F("value 0-255"), 1);
